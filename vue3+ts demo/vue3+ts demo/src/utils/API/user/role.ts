...
// 更新角色资源
export const updateRoleResource = (id: number, roleResource: RoleResource) => {
  return $http({
    url: '/user/role/updateRoleResource?role_id=' + id,
    method: 'post',
    data: roleResource
  });
};
...
// 根据id获取角色数据
export const getRoleFormDetail = (id: number) => {
  return $http({
